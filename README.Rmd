---
title: "Analysis of Water Temperature Trends Using SARIMA"
...
The histogram indicates that the data is multi-modal.  This is logical as the observations reflect seasonal data.  Changes between summer and winter create a bi-modal distribution of temperatures.  
...
ggplot(avgTemp20_full, aes(date, avg_temp)) +
  geom_line(color = "blue4") +
  labs(x="Days",
       y="Average Temperature (c)",
       title="Visualizing Missing Data by Day")
...
To model seasonal time series trends, I use a Seasonal Autoregressive Integrated Moving Average (SARIMA) model.
...
# best model for complete data set
# AIC = 0.373
# p=2,d=0,q=1,P=0,D=0,Q=1,S=26
model <- sarima(ts_complete, p=2,d=0,q=1,P=0,D=0,Q=1,S=26)
model
...
new_values <- 45
pred <- sarima.for(train, n.ahead = new_values, p=2,d=0,q=1,P=0,D=0,Q=1,S=26, 
                   main="Water Temperature Predictions",
                   xlab="Weeks")
lines(test)
...
print(paste("The RMSE for this SARIMA model is ", round(rmse, 4)))
```
